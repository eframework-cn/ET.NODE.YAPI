...
// 创建加密算法
const aesEncode = function (data, password) {
...
// 创建解密算法
const aesDecode = function (data, password) {
  /* 
...
exports.aesEncode = function (data, password) {
  if (!password) {
    yapi.WEBCONFIG.passsalt = yapi.WEBCONFIG.passsalt || defaultSalt;
    password = yapi.WEBCONFIG.passsalt;
  }
  return aesEncode(data, password);
}

exports.aesDecode = function (data, password) {
  if (!password) {
    yapi.WEBCONFIG.passsalt = yapi.WEBCONFIG.passsalt || defaultSalt;
    password = yapi.WEBCONFIG.passsalt;
  }
  return aesDecode(data, password);
}